...
export const metricSchema = z
  ...
  .superRefine((metric, context) => {
    if (
      metric.public &&
      !["verified", "approved-interpretation"].includes(
      ...
      context.addIssue({
        code: "custom",
        message:
          "Public metrics must be verified or an approved interpretation.",
  ...
  .superRefine((repository, context) => {
    if (repository.visibility === "private" && repository.accessibleToVisitor) {
      context.addIssue({
        code: "custom",
        message:
          "Private repositories cannot be exposed as visitor-accessible links.",
